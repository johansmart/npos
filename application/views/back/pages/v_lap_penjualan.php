    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <!-- /.box -->
            <table id="datatable" class="table table-bordered table-condensed table-striped table-striped" style="width: 100%">
...
<script type="text/javascript">
 $('#search').click(function(){
  ...
  'copy', 'csv',
    {
        ...
        filename: 'Lap_penjualan_'+'<?php echo date('dmY');?>'
    },
    {
        extend: 'pdfHtml5',
  ...
  "language": {
   ...
   //"order" : [],
   "ajax" : {
    url:"<?php echo base_url() . 'Lap_penjualan/fetch_lap_penjualan'; ?>",
    type:"POST",
    data:{
