  ...
  $(document).ready(function(){
    ...
    $('#datatable').DataTable( {
      ...
      processing: true,
        ...
        "ajax":{
          url :"<?php echo base_url() . 'Kategori/fetch_kategori'; ?>", // json datasource
          type: "post",
      ...
      $(document).on('click', '#edit', function(event){
        ...
        $('#edit_id_kategori').val(data_0);
        $('#edit_nama_kategori').val(data_1);
        //menampilkan data ke input text
      }); 
      /*end edit*/ 
      ...
      $(document).on('click', '#delete', function(event){
        ...
        var currentRow    = $(this).closest("tr")[0]; 
        var cells         = currentRow.cells;
        var kode_kategori = cells[0].textContent;
        var desc          = cells[1].textContent;
        bootbox.confirm("Hapus kategori: "+ " "+desc+" ?",function(confirmed){
        if (confirmed) {
...
<!-- insert kategori -->
<script type="text/javascript">
$(document).on('submit', '#add_kategori', function(event){
  event.preventDefault();
    ...
    if (confirmed) {
      ...
      success: function(data){
        if (data>0) 
        {
          ...
          $("#pesan").show();
          $("#msg").html('Kategori sudah terdaftar!');
        ...
        else
        {
          //menampilkan dan merubah class pesan
          $("#pesan").show();
          $("#msg").html('Kategori berhasil ditambahkan!');
...
<!-- edit kategori -->
<script type="text/javascript">
$(document).on('submit', '#edit_kategori', function(event){
  event.preventDefault();
  var id            = $('#edit_id_kategori').val();
    ...
    if (confirmed) {
      ...
      success: function(data){
        if (data>0) 
        {
          //menampilkan dan merubah class pesan
          $("#edit_pesan").show();
          $("#edit_msg").html('Kategori sudah terdaftar!');
        ...
        else
        {
          //menampilkan dan merubah class pesan
          $("#edit_pesan").show();
          $("#edit_msg").html('Edit kategori berhasil!');
...
<div class="modal fade modal-danger" id="modal_tambah">
  <form class="form-horizontal" id="add_kategori">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title"><span class="glyphicon glyphicon-plus"></span> Form Tambah Kategori</h4>
        </div>
...
<div class="modal fade modal-info" id="modal_edit">
  <form class="form-horizontal" id="edit_kategori">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        ...
        <div class="modal-body" style="background-color: white!important;">
          ...
          <div class="form-group">
            <label for="inputPassword3" class="col-md-2 control-label text-black">NAMA_KATEGORI</label>
            <div class="col-md-10">
              <input type="text" id="edit_nama_kategori" name="edit_nama_kategori" required="" class="form-control">
            </div>
          </div>
