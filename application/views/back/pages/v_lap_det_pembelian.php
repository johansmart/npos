        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Laporan Detil Pembelian</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <!-- /.box -->
...
<script type="text/javascript">
 $('#search').click(function(){
  ...
  'copy', 'csv',
    {
        ...
        filename: 'Lap_det_pembelian_'+'<?php echo date('dmY');?>'
    },
    {
        extend: 'pdfHtml5',
  ...
  "language": {
   ...
   //"order" : [],
   "ajax" : {
    url:"<?php echo base_url() . 'Lap_det_pembelian/fetch_lap_det_pembelian'; ?>",
    type:"POST",
    data:{
