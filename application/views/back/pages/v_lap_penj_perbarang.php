        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Laporan Penjualan Per Barang</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <!-- /.box -->
...
<script type="text/javascript">
 $('#search').click(function(){
  ...
  "footerCallback": function ( row, data, start, end, display ) {
    ...
    $( api.column( 3 ).footer() ).html(col_3.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
    $( api.column( 4 ).footer() ).html(col_4.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
  ...
  'copy', 'csv',
    {
        ...
        filename: 'Lap_penj_perbarang_'+'<?php echo date('dmY');?>'
    },
    {
        extend: 'pdfHtml5',
  ...
  "language": {
   ...
   //"order" : [],
   "ajax" : {
    url:"<?php echo base_url() . 'Lap_penj_perbarang/fetch_lap_penj_perbarang'; ?>",
    type:"POST",
    data:{
